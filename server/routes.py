...
# Sub-module Blueprints
from server.routes_agent import agent_bp
from server.routes_nodes import nodes_bp
from server.routes_smart import smart_bp
...
# [MOVED to routes_smart.py — smart_bp]
...
# [MOVED to routes_nodes.py — nodes_bp]

# [MOVED to routes_agent.py — agent_bp]
...
# ============================================================================
routes.register_blueprint(agent_bp)
routes.register_blueprint(nodes_bp)
routes.register_blueprint(smart_bp)
