...
def parse_nvme_smart(output: str) -> dict:
    ...
    nvme_meta = {
        ...
        'data_units_read': {"criticality": "info", "description": "Прочитано данных", "tooltip": "Общий объём чтения. Конвертируется в ГБ.", "unit": "nvme_blocks", "unit_divisor": 512 * 1000},
        'data_units_written': {"criticality": "info", "description": "Записано данных", "tooltip": "Общий объём записи. Конвертируется в ГБ.", "unit": "nvme_blocks", "unit_divisor": 512 * 1000},
        'host_reads': {"criticality": "info", "description": "Операций чтения", "tooltip": "Количество операций чтения хоста."},
        'host_writes': {"criticality": "info", "description": "Операций записи", "tooltip": "Количество операций записи хоста."},
